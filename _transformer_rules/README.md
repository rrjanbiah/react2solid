Language agnostic React to Solid code transformation rule, human readable description along with test cases (aka, sample use cases) are stored in `toml` files.
